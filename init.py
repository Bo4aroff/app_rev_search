...
year2 = st.slider("Год", max_value=max(a_df2['year'].unique().tolist()), min_value=min(a_df2['year'].unique().tolist()), value=(max(a_df2['year'].unique().tolist(), min(a_df2['year'].unique().tolist(), default=2024)))
